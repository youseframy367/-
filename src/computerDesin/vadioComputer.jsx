...
export default function LisonVadioCom() {
  ...
  color: "#fff"
      ...
      <div style={{display:"flex",justifyContent:"center",alignItems:"center",width:'15%'}}>
        ...
        <img style={{width:'90px',height:"90px"}}src={lisningImg}></img>
          ...
          <div style={{
            ...
            <h1 style={{ fontWeight: '700', fontSize: "32px",marginLeft:"20%", whiteSpace: "nowrap",display:'flex',justifyContent:"center",
                  overflow: "hidden",
                  textOverflow: "ellipsis",direction:"rtl",
                 width: "400px", }}>{surahName}</h1>
          </div>
                <div style={{display:"flex",justifyContent:"center",alignItems:"center",width:'15%'}}>
      ...
      {/* مشغل الصوت/الفيديو */}
      <div style={{
        display: "flex", flexDirection: "column", alignItems: "center",margin:"10px 7%"
      }}>
        ...
        {!isVideo && (
          <div style={{
            display: "flex", alignItems: "center", justifyContent: "center", width: "80%", margin:"10px 7%"
          }}>
